...
namespace WikiExtractorMod
{
    ...
    public class Extractor
    {
		...
		{
			Parcer.process(page, "wiki_data_old");
		}
	...
	//[HarmonyPatch(typeof(StationpediaPage), nameof(StationpediaPage.ParsePage))]
	//public class WikiPage {
	//	static void Prefix(StationpediaPage __instance) {
	//		Parcer.process(__instance);
	//	}
	//}
}